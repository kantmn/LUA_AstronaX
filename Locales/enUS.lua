...
l:RegisterTranslations("enUS", function() return {
   ...
   ["PvP"] = "PvP",
   ["NoNeed"] = "No Need",
   ["Disabled during combat"] = "Disabled during combat",
   ["is looking for"] = "is looking for",
   ["Combat Log was broken"] = "Combat Log was broken, we have resetted the cache.",
   ...
   ["spell_Schattengestalt"] = "Shadowform",
   ...
   ["spell_Aspekt"] = "Aspect",
   ["WeaponBuff MainHand"] = "Mainhand Weapon Enchant",
   ["WeaponBuff Offhand"] = "Offhand Weapon Enchant",
   ["Erdschild"] = "Earth Shield",
   ["WeaponBuff"] = "Weapon Enchant",
   ["spell_Segen der Macht"] = "Blessing of Might",
   ["spell_ruf"] = "Shout",
